"""
Opac1ty — 2-bit quantization with fused Metal dequant kernels for Apple Silicon.
...
from opac1ty.quantize.vq import VectorQuantizer
from opac1ty.quantize.codebook import CodebookLearner
from opac1ty.quantize.outlier import OutlierDetector
from opac1ty.format.bf2 import BF2Writer, BF2Reader
from opac1ty.format.header import BF2Header, LayerFormat
